...
export function AreaChart({ data, initialBalance, height = 256, className }: AreaChartProps) {
  ...
  return (
    <div className={cn("rounded-xl bg-gray-900/50 border border-gray-800 p-6", className)}>
      ...
      <div className="flex items-center justify-center gap-6 mt-4 text-xs text-gray-500">
        ...
        <div className="flex items-center gap-2">
          <div className="w-3 h-0.5 bg-gray-600" style={{ borderBottom: "1px dashed #6b7280" }} />
